    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-steel-50 to-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <Badge variant="outline" className="mb-3 sm:mb-4 text-primary border-primary px-3 sm:px-4 py-1 sm:py-2">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-lg mx-auto">
                ...
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-white text-white hover:bg-white hover:text-primary touch-manipulation h-12 sm:h-auto flex-1 sm:flex-none"
                >
