        ...
        <form onSubmit={handleSubmit}>
          ...
          {step === 3 && (
            <div className="space-y-4 animate-in fade-in duration-500">
              ...
              <ul className="text-steel-700 space-y-1">
                <li><b>Name:</b> {form.name}</li>
                <li><b>Email:</b> {form.email}</li>
                <li><b>Phone:</b> {form.phone}</li>
                <li><b>Property Type:</b> {form.propertyType}</li>
                <li><b>Needs:</b> {form.needs}</li>
                <li><b>Contact Method:</b> {form.contactMethod}</li>
          ...
          <div className="flex justify-between mt-8">
            ...
            {step === steps.length - 1 && (
              <Button type="submit" className="accent-gradient text-white">
                Submit
              </Button>
            )}
          </div>
