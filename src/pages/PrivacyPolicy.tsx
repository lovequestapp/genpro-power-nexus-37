...
const PrivacyPolicy = () => {
  return (
    <div>
      <SEO 
        title="Privacy Policy | HOU GEN PROS | Houston Generator Company"
        description="Privacy policy for HOU GEN PROS. Learn how we protect your personal information when you use our generator services in Houston and surrounding areas."
        keywords="privacy policy HOU GEN PROS, generator company privacy, Houston generator privacy, data protection generator company"
        canonical="/privacy"
        pageType="website"
      />
      <Header />
