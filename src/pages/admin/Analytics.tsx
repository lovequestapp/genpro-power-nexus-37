...
export default function Analytics() {
  ...
  return (
    <>
      <SEO title="Admin Analytics | HOU GEN PROS" description="Admin dashboard analytics page." canonical="/admin/analytics" pageType="website" keywords="admin, analytics, dashboard" schema={null} />
