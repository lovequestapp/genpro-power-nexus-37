...
export default function Scheduling() {
  ...
  return (
    <>
      <SEO title="Admin Scheduling | HOU GEN PROS" description="Admin dashboard scheduling page." canonical="/admin/scheduling" pageType="website" keywords="admin, scheduling, dashboard" schema={null} />
