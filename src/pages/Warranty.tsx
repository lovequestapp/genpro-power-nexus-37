...
const Warranty = () => {
  return (
    <div>
      <SEO 
        title="Generator Warranty Houston | Generac Warranty Service | HOU GEN PROS"
        description="Comprehensive generator warranty service in Houston. Generac warranty coverage, extended warranties, and warranty repair services. Protect your investment with our warranty programs."
        keywords="generator warranty Houston, Generac warranty Houston, generator warranty service Houston, extended generator warranty Houston, generator warranty repair Houston, warranty coverage Houston, generator protection plan Houston"
        canonical="/warranty"
        pageType="website"
      />
      <Header />
