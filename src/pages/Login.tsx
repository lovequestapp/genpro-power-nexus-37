...
export default function Login() {
  ...
  return (
    <div>
      <SEO 
        title="Login | HOU GEN PROS Customer Portal"
        description="Secure login for HOU GEN PROS customers and staff. Access your generator dashboard, billing, and support."
        canonical="/login"
        pageType="website"
        keywords="login, customer portal, HOU GEN PROS, generator account login"
        // Prevent indexing
        schema={null}
      />
