...
export default function CustomerBilling() {
  ...
  return (
    <>
      <SEO title="Customer Billing | HOU GEN PROS" description="Customer dashboard billing page." canonical="/customer/billing" pageType="website" keywords="customer, billing, dashboard" schema={null} />
