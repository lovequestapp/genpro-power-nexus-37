...
export default function CustomerSupport() {
  ...
  return (
    <>
      <SEO title="Customer Support | HOU GEN PROS" description="Customer dashboard support page." canonical="/customer/support" pageType="website" keywords="customer, support, dashboard" schema={null} />
